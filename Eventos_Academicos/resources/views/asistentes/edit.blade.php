<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('asistente.update',$asistente) }}" enctype="multipart/form-data" class="p-4 bg-white dark:bg-slate-800 rounded-md">
                @csrf
                @method('PUT')
                <div class=" grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="nombre_asistente" name="nombre_asistente" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{old('nombre_asistente', $asistente->nombre_asistente)}}">
                    ...
                    <div>
                        ...
                        <input type="text" id="apellidopat_asistente" name="apellidopat_asistente" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{old('apellidopat_asistente', $asistente->apellidopat_asistente)}}">
                    ...
                    <div>
                        ...
                        <select id="autor_id" name="autor_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option>Autor</option>
                            @foreach ($autor as $a)
                            <option value="{{ $a->id }}" @selected($a->id === $asistente->autor_id)> {{$a->nombre_autor}}</option>
                            @endforeach
                        </select>
                        @error('autor_id')
                        <div class="text-sm text-red-400">{{ $message }}</div>
