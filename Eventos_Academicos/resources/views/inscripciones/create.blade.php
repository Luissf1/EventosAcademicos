<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('inscripcion.store') }}" enctype="multipart/form-data" class="p-4 bg-blue dark:bg-slate-800 rounded-md">
                @csrf
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="fecha_inscripcion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fecha limite de inscripcion</label>
